    ...
    if submit_button:
        ...
        try:
            ...
            with col2:
                ...
                if avg_prob > 0.5:
                    st.markdown(f"""
                    <div class="prediction-box" style="background: rgba(220, 38, 38, 0.1); border-color: #ef4444;">
                        <h3 style="background: none; -webkit-text-fill-color: currentcolor; color: #fca5a5;">⚠️ High Churn Risk</h3>
                        <p style="font-size: 1.2em; color: #e2e8f0;">This customer has a <strong style="color: #fca5a5;">{avg_prob*100:.1f}%</strong> probability of churning.</p>
                        <p style="color: #cbd5e1;"><strong style="color: #e2e8f0;">Recommended Actions:</strong></p>
                    ...
                    st.markdown(f"""
                    <div class="prediction-box" style="background: rgba(22, 163, 74, 0.1); border-color: #22c55e;">
                        <h3 style="background: none; -webkit-text-fill-color: currentcolor; color: #86efac;">✅ Low Churn Risk</h3>
                        <p style="font-size: 1.2em; color: #e2e8f0;">This customer has only a <strong style="color: #86efac;">{avg_prob*100:.1f}%</strong> probability of churning.</p>
                        <p style="color: #cbd5e1;"><strong style="color: #e2e8f0;">Recommended Actions:</strong></p>
                        <ul style="color: #cbd5e1;">
